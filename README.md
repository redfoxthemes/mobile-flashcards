...
Mobile-Flashcards application allows a user to create decks of cards for study practice.
It has the ability to add and remove Decks.
It has the ability to add Cards to each deck.
It has the ability to run a Quiz, which allows the user to mark correct and incorrect responses and gives a total score.
